    ...
    <div className="bg-token-main-surface-primary sticky top-0 z-10 flex min-h-[40px] items-center justify-center bg-white pl-1 dark:bg-gray-800 dark:text-white md:hidden">
      ...
      >
        ...
        <svg
          ...
          className="icon-md"
        >
          <path d="M4 7H20" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" />
          <path d="M4 12H20" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" />
          <path d="M4 17H20" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" />
        </svg>
      </button>
      <h1 className="sigmacode-title flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-center text-sm">
